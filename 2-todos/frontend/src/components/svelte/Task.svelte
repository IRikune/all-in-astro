...
<div class="container mx-auto p-8">
    <div class="mb-8 flex flex-col gap-2">
        ...
        <p class="text-gray-600">
            Try clicking the items or delete buttons while also being able to
        ...
        {#each items as item, index (item.id)}
            <div
                use:droppable={{
                    ...
                    attributes: {
                        draggingClass: "scale-101 opacity-60 skew-1",
                        dragOverClass: "scale-102 opacity-60",
                    },
                }}
                use:draggable={{
                    container: index.toString(),
                    attributes: {
                        draggingClass: "scale-102 opacity-60 skew-1",
                        dragOverClass: "scale-101 opacity-60",
                    },
                    dragData: item,
                    interactive: [
                        "[data-delete-btn]",
