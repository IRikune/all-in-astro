	...
	return (
		...
		>
			<div class="w-[62%] h-[85%] z-20 top-[7.5%] shadow-2xl left-[19%] fixed overflow-hidden rounded-2xl bg-white  ">
				<div
					class={"grid grid-rows-[min(2.5rem)_1fr] grid-cols-[3fr_1.5fr] h-full p-2.5 w-full"}
				>
					<Button
						icon="inbox"
					...
					<div class="flex justify-end">
						...
						<label for="view-task-options">
							<div
								class={"grid content-center hover:bg-gray-200 w-10 h-10 rounded text-neutral-700 active:bg-gray-300 justify-center"}
							>
								<CrossIcon />
							</div>
						</label>
					...
					<div
						class={"grid grid-rows-[1fr] gap *:w-full *:gap text-[12px] bg-neutral-100/50 py-2.5 px-4 "}
					>
						<div>
							<section>
							...
							<section class={"relative"}>
								...
								<Button
									onclick={() => {
										selecPriority.value = !selecPriority
											.value;
									}}
								...
								<dialog
									...
									class={"w-30 h-28 las last:self-end left-[65%] fixed rounded-[10px] z-1 overflow-hidden shadow"}
								>
