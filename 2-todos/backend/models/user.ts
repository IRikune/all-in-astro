import { kv, ulid } from '../main.js';
import type { User, UserID, newUser } from '../types/mod.js';
...
export async function updateUser(userID: string, upDatedUser: newUser) {
	const key = ['users', userID];
